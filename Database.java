...
//	private ArrayList<Student> studenten;
	...
	public void adduserwithoutnumberOfSemesters(String lastname, String firstName, int matknr)
	{
		...
		students.add(new Student(lastname,firstName,matknr));
	}
	
	public void update(String lastname, String vorname, int matknr,int numberOfSemesters)
	{
		...
		Student temp = new Student(lastname,vorname,matknr,numberOfSemesters);
		int counter = 0 ;
	...
	public void printcommands()
	{
		...
		System.out.println("To create a user use the command: ('create' lastname;firstname;numberOfSemesters)");
		System.out.println("To retrieve a user use the command: ('retrieve';matriculation number')");
		System.out.println("To update a user use the command: ('update';name;firstname;numberOfSemesters)");
		System.out.println("To delete a user use the command: ('delete';matriculation number)");
